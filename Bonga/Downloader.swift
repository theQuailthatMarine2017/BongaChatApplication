...
//  Bonga
//
//  Created by RastaOnAMission on 20/10/2018.
...
func uploadImage(image: UIImage, chatRoomId: String, view: UIView, completion: @escaping (_ imageLink: String?) -> Void ) {
    ...
    let photoFileName = "Picture Message/" + FUser.currentId() + "/" + chatRoomId + "/" + dateString + ".jpg"
...
func uploadVideo(video: NSData, chatRoomId: String, view: UIView, completion: @escaping(_ videoLink: String?) -> Void) {
    ...
    task = storageRef.putData(video as Data, metadata: nil, completion: { (metadata, error) in
        ...
        if error != nil {
            ...
            print("couldnt upload video: \(String(describing: error?.localizedDescription))")
            return
...
// audio upload function then download function

func uploadAudio(audioPath: String, chatRoomId: String, view: UIView, completion: @escaping(_ videoLink: String?) -> Void) {
    ...
    task = storageRef.putData(audio! as Data, metadata: nil, completion: { (metadata, error) in
        ...
        if error != nil {
            ...
            print("couldnt upload audio: \(String(describing: error?.localizedDescription))")
            return
